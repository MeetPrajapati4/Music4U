...
<head>
    ...
    <title>Music4U : CurrentUserProfile</title>
...
<body>
    ...
    <span id="dataset" style="display: none;">
        ...
        if (isset($_SESSION['Username'])) {
            ...
            $sql = "SELECT * FROM Asusers WHERE User_Id='$userid'";
            ...
            if ($res && $res->num_rows > 0) {
                ...
                if ($_SERVER["REQUEST_METHOD"] == 'POST') {
                    ...
                    if (!empty($password)) {
                        $update_fields[] = "Pass='" . password_hash($password, PASSWORD_DEFAULT) . "'";
                    }
                    if (!empty($email)) {
        ...
        ?>
                ...
                <div class="container">
                    <form method="POST" enctype="multipart/form-data" action="<?php echo $_SERVER["REQUEST_URI"]; ?>" class="frm">
                        ...
                        <button type="submit" id="update" name="update" onclick="window.location.href='MyProfile.php'">Update</button>
