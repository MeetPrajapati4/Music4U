...
<head>
    ...
    <title>Music4U : New Release</title>
    ...
    <nav class="navbar">
        ...
        <script>
            ...
            <?php if (isset($username)): ?>
                const textArray = [
                    `Hello ${<?php echo json_encode(ucwords(explode(' ', $username)[0])); ?>}`,
                    "Music4U - New Release Songs"
                ];
                let i = 0;
        ...
        <div class="container">
                ...
                document.addEventListener('DOMContentLoaded', () => {
                    ...
                    buttons.forEach(button => {
                        button.addEventListener('click', () => {
                            ...
                            const currentPage = window.location.pathname.split('/').slice(-1)[0].split('.')[0];
            ...
            <div class="center">
                <table>
                    ...
                    <?php
                    $sql = "SELECT * FROM songs WHERE Music_Id NOT IN (8,14, 16, 54, 55, 65, 67, 80, 81, 83, 86, 89, 90, 94, 124, 134, 135, 136, 140, 142, 143, 145, 149, 152, 158, 161, 162,166,167,168,169,170,171,172,173,174,175,176) ORDER BY Music_Id DESC LIMIT 50";
                    $result = mysqli_query($conn, $sql);
                    while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                        <?php
